...
var menuCategorias = function (props) {
    var agendaNavIcon = props.agendaNavIcon, novedadesNavIcon = props.novedadesNavIcon, presentacionesNavIcon = props.presentacionesNavIcon;
    return [
        { name: "Inicio", Icon: HomeIcon, perfiles: [], link: "/" },
        {
            ...
            items: [
                ...
                {
                    name: "Presentaciones",
                    Icon: { presentacionesNavIcon: presentacionesNavIcon },
                    link: "/presentaciones",
                    perfiles: [],
                },
                {
